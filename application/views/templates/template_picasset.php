...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= site_url('picasset'); ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?= site_url('picasset'); ?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingMaster" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="<?= site_url('mahasiswa'); ?>">Mahasiswa</a>
                        <a class="collapse-item" href="<?= site_url('periode'); ?>">Periode</a>
                        <a class="collapse-item" href="<?= site_url('laptop'); ?>">Laptop</a>
                        <a class="collapse-item" href="<?= site_url('laboratorium'); ?>">Laboratorium</a>
                    </div>
                </div>
            </li>
