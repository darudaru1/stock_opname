...
class PicAdmin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['content'] = 'dashboard/picadmin'; // Menentukan tampilan yang akan dimuat di dalam template
        $this->load->view('templates/template_picadmin', $data);
    }
}
