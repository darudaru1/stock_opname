...
class PicLab extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['content'] = 'dashboard/piclab'; // Menentukan tampilan yang akan dimuat di dalam template
        $this->load->view('templates/template_piclab', $data);
    }
}
